...
class HappyBookingScreen extends StatefulWidget {
  final String userId;
  const HappyBookingScreen({super.key, required this.userId});
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
                shape: BoxShape.circle, color: greenColor.withOpacity(.15)),
            child: const Icon(
              Icons.check,
              color: greenColor,
              size: 70,
          ...
          Row(
            ...
            children: [
              CustomButtonBig(
                  btnHeading: "Go To History Page",
                  loading: loader,
                  onTap: () {
                    loader = true;
                    // Future.delayed(const Duration(seconds: 2));
                    // context.go("/");
                    context.replace("/rentalForm/rentalHistory",
